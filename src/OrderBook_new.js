...
const OrderBook = () => {
  ...
  const [filters, setFilters] = useState({
    filterType: 'current-date', // all, current-date, date-range, pnl, margin, tag, symbol
    startDate: '',
    endDate: '',
    minPnl: '',
    maxPnl: '',
  ...
  console.log('Current records state:', records.length);
  ...
  console.log('About to render, sortedData length:', sortedData.length);
